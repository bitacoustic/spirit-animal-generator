...
--
-- Host: localhost:3306
-- Generation Time: Sep 25, 2016 at 04:18 AM
...
--
-- Database: `asrsaiwc_spiritanimal`
--
...
INSERT INTO `colors` (`uname`, `name`, `hexcode`, `red`, `green`, `blue`) VALUES
('air_force_blue_raf', 'Air Force Blue', '#5d8aa8', 93, 138, 168),
('air_force_blue_usaf', 'Air Force Blue', '#00308f', 0, 48, 143),
...
('amber_sae_ece', 'Amber', '#ff7e00', 255, 126, 0),
...
('blue_crayola', 'Blue', '#1f75fe', 31, 117, 254),
('blue_gray', 'Blue Gray', '#69c', 102, 153, 204),
('blue_green', 'Blue-Green', '#0d98ba', 13, 152, 186),
('blue_munsell', 'Blue', '#0093af', 0, 147, 175),
('blue_ncs', 'Blue', '#0087bd', 0, 135, 189),
('blue_pigment', 'Blue', '#339', 51, 51, 153),
('blue_ryb', 'Blue', '#0247fe', 2, 71, 254),
...
('brown_traditional', 'Brown', '#964b00', 150, 75, 0),
('brown_web', 'Brown', '#a52a2a', 165, 42, 42),
...
('caf_au_lait', 'Cafe Au Lait', '#a67b5b', 166, 123, 91),
('caf_noir', 'Cafe Noir', '#4b3621', 75, 54, 33),
...
('carmine_m_p', 'Carmine', '#d70040', 215, 0, 64),
...
('celeste_colour', 'Celeste', '#b2ffff', 178, 255, 255),
...
('chartreuse_traditional', 'Chartreuse', '#dfff00', 223, 255, 0),
('chartreuse_web', 'Chartreuse', '#7fff00', 127, 255, 0),
...
('chocolate_traditional', 'Chocolate', '#7b3f00', 123, 63, 0),
('chocolate_web', 'Chocolate', '#d2691e', 210, 105, 30),
...
('copper_crayola', 'Copper', '#da8a67', 218, 138, 103),
...
('cyan_process', 'Cyan', '#00b7eb', 0, 183, 235),
...
('forest_green_traditional', 'Forest Green', '#014421', 1, 68, 33),
('forest_green_web', 'Forest Green', '#228b22', 34, 139, 34),
...
('fuchsia_crayola', 'Fuchsia', '#c154c1', 193, 84, 193),
...
('gold_metallic', 'Gold', '#d4af37', 212, 175, 55),
('gold_web_golden', 'Gold', '#ffd700', 255, 215, 0),
...
('gray_html_css_gray', 'Gray', '#808080', 128, 128, 128),
('gray_x11_gray', 'Gray', '#bebebe', 190, 190, 190),
('green_color_wheel_x11_green', 'Green', '#0f0', 0, 255, 0),
('green_crayola', 'Green', '#1cac78', 28, 172, 120),
('green_html_css_green', 'Green', '#008000', 0, 128, 0),
('green_munsell', 'Green', '#00a877', 0, 168, 119),
('green_ncs', 'Green', '#009f6b', 0, 159, 107),
('green_pigment', 'Green', '#00a550', 0, 165, 80),
('green_ryb', 'Green', '#66b032', 102, 176, 50),
('green_yellow', 'Green-Yellow', '#adff2f', 173, 255, 47),
('grullo', 'Grullo', '#a99a86', 169, 154, 134),
('guppie_green', 'Guppie Green', '#00ff7f', 0, 255, 127),
('halay_be', 'Halaya uBe', '#663854', 102, 56, 84),
...
('indigo_dye', 'Indigo', '#00416a', 0, 65, 106),
('indigo_web', 'Indigo', '#4b0082', 75, 0, 130),
('international_klein_blue', 'International Klein Blue', '#002fa7', 0, 47, 167),
('international_orange_aerospace', 'International Orange', '#ff4f00', 255, 79, 0),
('international_orange_engineering', 'International Orange', '#ba160c', 186, 22, 12),
('international_orange_golden_gate_bridge', 'International Orange', '#c0362c', 192, 54, 44),
...
('khaki_html_css_khaki', 'Khaki', '#c3b091', 195, 176, 145),
('khaki_x11_light_khaki', 'Khaki', '#f0e68c', 240, 230, 140),
...
('lavender_floral', 'Lavender', '#b57edc', 181, 126, 220),
...
('lavender_web', 'Lavender', '#e6e6fa', 230, 230, 250),
...
('lime_color_wheel', 'Lime', '#bfff00', 191, 255, 0),
('lime_green', 'Lime Green', '#32cd32', 50, 205, 50),
('lime_web_x11_green', 'Lime', '#0f0', 0, 255, 0),
...
('magenta_dye', 'Magenta', '#ca1f7b', 202, 31, 123),
('magenta_process', 'Magenta', '#ff0090', 255, 0, 144),
...
('maroon_crayola', 'Maroon', '#c32148', 195, 33, 72),
('maroon_html_css', 'Maroon', '#800000', 128, 0, 0),
('maroon_x11', 'Maroon', '#b03060', 176, 48, 96),
...
('midnight_green_eagle_green', 'Midnight Green', '#004953', 0, 73, 83),
...
('peach_crayola', 'Peach', '#ffcba4', 255, 203, 164),
...
('plum_traditional', 'Plum', '#8e4585', 142, 69, 133),
('plum_web', 'Plum', '#dda0dd', 221, 160, 221),
('portland_orange', 'Portland Orange', '#ff5a36', 255, 90, 54),
('powder_blue_web', 'Powder Blue', '#b0e0e6', 176, 224, 230),
...
('red_munsell', 'Red', '#f2003c', 242, 0, 60),
('red_ncs', 'Red', '#c40233', 196, 2, 51),
('red_orange', 'Red-Orange', '#ff5349', 255, 83, 73),
('red_pigment', 'Red', '#ed1c24', 237, 28, 36),
('red_ryb', 'Red', '#fe2712', 254, 39, 18),
...
('royal_blue_traditional', 'Royal Blue', '#002366', 0, 35, 102),
('royal_blue_web', 'Royal Blue', '#4169e1', 65, 105, 225),
...
('safety_orange_blaze_orange', 'Safety Orange', '#ff6700', 255, 103, 0),
...
('scarlet_crayola', 'Scarlet', '#fd0e35', 253, 14, 53),
...
('shocking_pink_crayola', 'Shocking Pink', '#ff6fff', 255, 111, 255),
...
('smalt_dark_powder_blue', 'Smalt', '#039', 0, 51, 153),
...
('tea_rose_orange', 'Tea Rose', '#f88379', 248, 131, 121),
('tea_rose_rose', 'Tea Rose', '#f4c2c2', 244, 194, 194),
...
('tenn_tawny', 'Tenné', '#cd5700', 205, 87, 0),
...
('vermilion_cinnabar', 'Vermilion', '#e34234', 227, 66, 52),
('vermilion_plochere', 'Vermilion', '#d9603b', 217, 96, 59),
('veronica', 'Veronica', '#a020f0', 160, 32, 240),
('violet', 'Violet', '#8f00ff', 143, 0, 255),
('violet_blue', 'Violet-Blue', '#324ab2', 50, 74, 178),
('violet_color_wheel', 'Violet', '#7f00ff', 127, 0, 255),
('violet_ryb', 'Violet', '#8601af', 134, 1, 175),
('violet_web', 'Violet', '#ee82ee', 238, 130, 238),
...
('yellow_munsell', 'Yellow', '#efcc00', 239, 204, 0),
('yellow_ncs', 'Yellow', '#ffd300', 255, 211, 0),
('yellow_orange', 'Yellow Orange', '#ffae42', 255, 174, 66),
('yellow_process', 'Yellow', '#ffef00', 255, 239, 0),
('yellow_ryb', 'Yellow', '#fefe33', 254, 254, 51),
...
INSERT INTO `dinosaurs` (`name`) VALUES
('Blancocerosaurus'),
('Brontoraptor'),
('Byranjaffia'),
('Calamospondylus Lydekker 1889'),
('Camptonotus'),
('Campylodon'),
('Capitalsaurus'),
('Changdusaurus'),
...
('Great Japanese Dog'),
('Great Pyrenees'),
('Greater Swiss Mountain Dog (Grosser Schweizer Senn'),
('Greek Harehound'),
...
('Istarski Ostrodlaki Gonic (Istrian Coarse-Haired H'),
('Istrian Sheepdog'),
('Italian Greyhound'),
('Italian Spinone'),
...
('Polish Lowland Sheepdog (Polski Owczarek Nizinny o'),
